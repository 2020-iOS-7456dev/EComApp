//
//  RKActivityIndicatorView.swift
//  Collab
//
//  Created by Raj Kadam on 24/07/18.
...
public class RKActivityIndicator: NSObject {
    ...
    fileprivate var backgroundViewColor: UIColor  = UIColor.init(red: 1.0, green: 1.0, blue: 1.0, alpha: 1)
    fileprivate var activityIndicatorStyle: ActivityIndicatorStyle = .spinningFadeCircle
    fileprivate var activityIndicatorTranslucency: UIBlurEffect.Style = .extraLight
    
    // MARK: - Singleton Accessors
    fileprivate static let shared: RKActivityIndicator = {
        let instance = RKActivityIndicator()
    ...
    fileprivate func configureActivityIndicator(withStatusMessage message: String, isUserInteractionEnabled userInteractionStatus: Bool) {
        ...
        if spinnerContainerView != nil {
            ...
            RKActivityIndicatorStyle.createSpinner(in: viewLayer, size: animationRectsize, color: spinnerColor, style: activityIndicatorStyle)
        }
        ...
        activityIndicatorView?.barTintColor = .white
